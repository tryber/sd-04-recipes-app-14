...
export const getMealFiltered = (filtro) =>
  fetch(MEALFILTERS + `${filtro}`).then((res) => res.json());
export const getDrinksFiltered = (filtro) =>
  fetch(DRINKFILTERS + `${filtro}`).then((res) => res.json());
